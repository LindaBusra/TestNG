...
public class Day22_SearchItem {
    ...
    public void googleSearch() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//*[.='Accept all']")).click();  //for alert
        driver.findElement(By.xpath("//input[@class='gLFyf']")).sendKeys("porcelain teapot"+ Keys.ENTER);
        driver.quit();
    }
    @Test
    ...
    public void amazonSearch() throws InterruptedException {
        ...
        //We are going to run in multiple browser.
        //cross-browsing testing-->testing with different browser
        //parallel testing:testing with multiple browser
        //number of browsers, the run same time ;   thread-count="3"
    }
}
